...
<div class="col-lg-10 vh-100">
                    <div class="card mt-4">
                        <div class="card-header">
                            <a name="" class="btn btn-primary" href="/user/formuliruser" role="button"> <i class="bi bi-plus-square-fill"></i>+ User</a>
                            ...
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $u->nama_user }}</td>
                                        <td>
                                            <a href="/user/edituser/{{ $u->id }}" class="btn btn-outline-primary"><i class="bi bi-pencil-square">Edit</i></a>
